        ...
        <div className="flex min-h-screen items-center justify-center bg-black px-4 relative overflow-hidden">
            ...
            <Card className="w-full max-w-sm bg-neutral-900/50 border-white/10 backdrop-blur-xl relative z-10">
                <CardHeader className="space-y-4 text-center">
                    ...
                    <div>
                        <Badge variant="outline" className="mb-2 border-indigo-500/30 bg-indigo-500/10 text-indigo-300">
                        ...
                        <CardDescription className="text-neutral-400 font-medium">
                            Join the next generation of creative ops.
                        </CardDescription>
                    </div>
                </CardHeader>
                ...
                <CardFooter className="flex flex-col gap-4">
                    ...
                    <p className="px-8 text-center text-[10px] text-neutral-600 font-medium leading-relaxed">
                        By signing up, you agree to our{" "}
                        <a href="#" className="underline underline-offset-4 hover:text-neutral-400 transition-colors">
                            Terms
                        </a>{" "}
                        and{" "}
                        <a href="#" className="underline underline-offset-4 hover:text-neutral-400 transition-colors">
